...
settings["compact"]["font"]["font_height"] = 14;
settings["compact"]["font"]["color"] = 4294967295;
settings["compact"]["y"] = 1416;
...
settings["token_order_default"] = "[XP] [Merits] [XPHour] [XPChain] [DIV]##1 [CP] [JP] [JPHour] [CPChain] [DIV]##2 [Sparks] [DIV]##3 [Accolades] [DIV]##4 [Gil]";
settings["bar_y"] = 15;
