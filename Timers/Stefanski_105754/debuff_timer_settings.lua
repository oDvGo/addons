...
settings["max_height"] = 527;
settings["padding"][1] = 6;
...
settings["background"]["position_x"] = 1731;
settings["background"]["locked"] = true;
settings["background"]["height"] = 0;
settings["background"]["position_y"] = 292;
settings["font_family"] = "Arial";
settings["name_font_offset_x"] = 11;
