...
settings["icon_scale"] = 0.65100002288818359;
settings["icon_offset_y"] = 0;
settings["max_height"] = 701;
settings["padding"][1] = 12;
settings["padding"][2] = 7;
settings["padding"][3] = 12;
settings["padding"][4] = 7;
...
settings["bar_width"] = 220;
settings["font_fg_color"] = -3604736;
settings["background"]["width"] = 200;
settings["background"]["border_sizes"] = "2,2,2,2";
settings["background"]["color"] = 1074331752;
