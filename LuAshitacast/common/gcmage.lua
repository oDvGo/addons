    ...
    if (player.MainJob == 'RDM' or player.MainJob == 'WHM' or player.MainJob == 'BRD' or player.MainJob == 'SMN') then
		if (player.Status == 'Engaged') then
            ...
            elseif (gcdisplay.IdleSet == 'Fight') then
                ...
                if (player.MainJob == 'RDM' and tp_fencers_ring and player.HPP <= 75 and player.TP <= 1000 and (gData.GetBuffCount('Enfire') + gData.GetBuffCount('Enblizzard') + gData.GetBuffCount('Enaero') + gData.GetBuffCount('Enstone') + gData.GetBuffCount('Enthunder') + gData.GetBuffCount('Enwater'))>0) then
