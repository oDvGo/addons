...
local sets = {
    Idle = { -- 1415
        ...
        Hands = 'Kampfhentzes',
        Ring1 = 'Woodsman Ring',
        Ring2 = { Name = 'Rajas Ring', Priority = 100 },
        Back = 'High Brth. Mantle',
        Waist = 'Tilt Belt',
        Legs = { Name = 'Kampfdiechlings', Priority = 10 },
        Feet = { Name = 'Republic Greaves', Priority = 90 },
    },
    IdleALT = {
    },
    IdleDT = { -- 1415
        ...
        Neck = { Name = 'Peacock Amulet', Priority = 100 },
    ...
    Hate = { -- 1419
        ...
        Hands = { Name = 'Devotee\'s Mitts', Priority = 80 },
        Ring1 = 'Hercules\' Ring',
        Ring2 = { Name = 'Sattva Ring', Priority = 100 },
        Back = { Name = 'Valor Cape', Priority = 100 },
        Waist = 'Warwolf Belt',
        Legs = { Name = 'Custom Pants', Priority = -100 },
        Feet = 'Vlr. Leggings +1',
    },
    ...
    Cheat_C3HPUp = { -- 1430 (223)
        ...
        Back = 'High Brth. Mantle',
        Waist = 'Tilt Belt',
        Legs = { Name = 'Custom Pants', Priority = 10 },
        Feet = { Name = 'Custom F Boots', Priority = 90 },
    },
    Cheat_C4HPDown = { -- 1072
        --Main = 'Durandal',
        --Sub = 'Aegis',
