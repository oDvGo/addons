...
local whmSJMaxMP = 961 -- The Max MP you have when /whm in your idle set
...
local sets = {
    ...
    WaterRes = { -- 137
		...
		Range = '',
        Ammo = 'Phtm. Tathlum',
        Head = 'Dls. Chapeau +1', -- 10
        Neck = 'Healing Torque', -- 10
        Ear1 = 'Merman\'s Earring', -- 11
        Ear2 = 'Merman\'s Earring', -- 11
        Body = 'Errant Hpl.', -- 6
        Hands = 'Dls. Gloves +1', -- 4
        Ring1 = 'Merman\'s Ring', -- 10
        Ring2 = 'Merman\'s Ring', -- 10
        Back = 'Cheviot Cape',
