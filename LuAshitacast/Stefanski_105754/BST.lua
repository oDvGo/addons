...
local pets = T{'sheep','lizard','crab','tiger','rabbit','mandy','flytrap','antican'}
...
profile.HandleAbility = function()
    ...
    elseif (action.Name == 'Call Beast') then
		...
		elseif (pet == 'Antican') then
            if (player.MainJobSync >= 63) then
                gFunc.Equip('Ammo', 'F. Antica Broth')
            elseif (player.MainJobSync >= 38) then
